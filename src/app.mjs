...
app.use(cors({
  origin: [corsDomain1, 'https://sound-zone-diplomatura.netlify.app'], //'http://localhost:----' o '*' para permitir cualquier origen ['http://localhost:----', 'https://tu-dominio-en-produccion.com']
