...
import {consumirApiExternaDeRecetasController, obtenerTodosLosPaisesController,
    ...
    obtenerTodasLasRecetasController, obtenerRecetasPorRegionController
} from '../controllers/recetasController.mjs';
...
router.get('/recetas/', obtenerTodasLasRecetasController);
router.get('/recetas/porRegion', obtenerRecetasPorRegionController);
